...
public class Successful_Advance_COD extends ActionBarActivity {
   // String s;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      System.out.print(currentadd+"77777777777");
    }
    ...
    private void registerUser(Order order) {
        ...
        serverRequest.orderInBackground(order, new GetOrderCallback() {
            ...
            public void done(Order returnedUser) {
                ...
                final Intent intent = new Intent(Successful_Advance_COD.this, AfterAdv.class);
