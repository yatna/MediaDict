...
public class SuccessfullInstant_Online extends ActionBarActivity {
    // String s;
    ...
    private void registerUser(Order order) {
        ...
        serverRequest.orderInBackground(order, new GetOrderCallback() {
            ...
            public void done(Order returnedUser) {
                ...
                final Intent intent = new Intent(SuccessfullInstant_Online.this, AfterAdv.class);
