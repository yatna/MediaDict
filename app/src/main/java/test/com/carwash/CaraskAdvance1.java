 ...
 */
public class CaraskAdvance1 extends ActionBarActivity implements View.OnClickListener {
...
TextView etdate;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carask_advance);
...
etdate= (TextView) findViewById(R.id.etdate);
    ...
    public void next(View v){
        ...
        t=et.getText().toString();
        tt=et2.getText().toString();
        Intent i=new Intent(this,CartnewAdvance.class);
